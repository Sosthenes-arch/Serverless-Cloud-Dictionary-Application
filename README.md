...
This project is a **Serverless Cloud Dictionary** web application that allows users to search for definitions of various cloud-computing terms. It demonstrates a **Three-Tier Serverless Architecture** on AWS using **React** for the frontend, **API Gateway** for the logic tier, and **DynamoDB** for storage.
...
_Note: This repository primarily contains the Frontend code and Data records. You need to provision the backend infrastructure on AWS._
